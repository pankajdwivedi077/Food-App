...
import com.bell.food.entity.CartEntity;
import com.bell.food.io.CartRequest;
import com.bell.food.io.CartResponse;
import com.bell.food.repository.CartRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public CartResponse getCart() {
        String loggedInUserId = userService.findByUserId();
        System.out.println("Fetching cart for user ID: " + loggedInUserId); // Debug log

        CartEntity entity = cartRepository.findByUserId(loggedInUserId)
                .orElse(new CartEntity(null, loggedInUserId, new HashMap<>()));

        System.out.println("Cart found: " + entity); // Debug log
