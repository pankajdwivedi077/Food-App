...
function Register() {
  ...
  const onSubmitHandler = async (e) => {
   ...
   try{
     ...
     toast.error("Unable to regisgter. please try again")
   }
  }
          ...
          <div className="card-body p-4 p-sm-5">
            ...
            <form onSubmit={onSubmitHandler} >
              <div className="form-floating mb-3">
                <input type="text" className="form-control" id="floatingName" placeholder="Joe Doe" name="name" onChange={onChangeHandler} value={data.name} required />
